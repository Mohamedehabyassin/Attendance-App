...
class _MapsState extends State<Maps> {
  ...
  static final CameraPosition initialLocation = CameraPosition(
    target: LatLng(30.044281, 31.340002),
    zoom: 15,
  );

  Future<Uint8List> getMarker() async {
    ByteData byteData = await DefaultAssetBundle.of(context).load("assets/images/school_bus.PNG");
...
//    return Scaffold(
//      appBar: AppBar(
//        title: Center(child:Text("Bus Line")) ,
//      ),
//     body: Stack(
//       children: <Widget>[
//         GoogleMap(
